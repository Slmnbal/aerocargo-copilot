...
def optimize_routes(top_n=20):
    ...
    return {
        ...
        "results": results[["route", "origin", "flight_count", "assigned_flights"]],
    }


if __name__ == "__main__":
    cikti = optimize_routes()
    print(f"Durum: {cikti['status']} (1 = optimal)")
    print(f"Toplam kapasite: {cikti['total_capacity']}")
    print(cikti["results"])
